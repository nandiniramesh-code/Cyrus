        ...
        <header className={`${isScrolled ? 'fixed top-0 left-0 right-0 bg-white shadow-md z-50' : 'bg-white shadow-md'} transition-all duration-300`}>
          <div className="container mx-auto px-6 py-4">
            <div className="flex items-center justify-between">
              ...
              {/* Donate Button */}
              <Link href="/Donate" className="hidden md:block bg-red-600 hover:bg-red-700 text-white font-medium py-2 px-6 rounded-full">
                Donate
              </Link>
          ...
          <div className="container mx-auto px-6 py-12">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li><Link href="/programs" className="text-gray-400 hover:text-white">Our Programs</Link></li>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li><Link href="/fundraise" className="text-gray-400 hover:text-white">Fundraise</Link></li>
                  <li><Link href="/volunteer" className="text-gray-400 hover:text-white">Volunteer</Link></li>
                  <li><Link href="/corporate" className="text-gray-400 hover:text-white">Corporate Partners</Link></li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li className="text-gray-400">123 Foundation Road</li>
                  <li className="text-gray-400">New York, NY 10001</li>
                  <li className="text-gray-400">info@cyrusfoundation.org</li>
            ...
            <div className="mt-12 border-t border-gray-800 pt-8">
              <p className="text-center text-gray-400">
                © {new Date().getFullYear()} Cyrus Development Foundation Inc. All rights reserved.
              </p>
            </div>
          </div>
        </footer>
